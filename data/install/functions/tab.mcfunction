...
tellraw @a [{"text":"【更新公告】","color":"gold","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"clickEvent":{"action":"open_url","value":"https://website.dbhg.top/website/minecraft/datapack/Breeding_animal_Hunter_Game/tab"}}]
tellraw @a [{"text":"-------------------------------------------"}]